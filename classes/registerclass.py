...
class UserRegistrationApp(customtkinter.CTk):
    ...
    def setup_ui(self):
        ...
        self.firstname = customtkinter.CTkEntry(master=fr, width=300, height=40, placeholder_text="Nome Completo")
        self.firstname.pack(pady=12, padx=10)

        self.entry1 = customtkinter.CTkEntry(master=fr, width=300, height=40, placeholder_text="Usuário")
        self.entry1.pack(pady=12, padx=10)

        self.entry2 = customtkinter.CTkEntry(master=fr, width=300, height=40, placeholder_text="Senha", show="*")
        self.entry2.pack(pady=12, padx=10)

        self.combo = customtkinter.CTkComboBox(master=fr, width=300, height=40, values=["OPERADOR", "GERENTE"])
        self.combo.pack(pady=12, padx=10)

        button = customtkinter.CTkButton(master=fr, width=300, height=40, text="CADASTRAR", command=self.reg)
